...
# Train the model
train_model(train_loader, model, class_name_to_idx, num_epochs=90, val_loader=val_loader, model_save_path=model_save_path, autocast_enabled=True)
