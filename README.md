...
We evaluated our model across three tasks using the following metrics:

- **Keypoint Detection**  
  - Percentage of Correct Keypoints (PCKh @ 0.5)  
  - Mean Squared Error (MSE) on keypoint heatmaps.
